...
#ifndef CONSISTENCYTESTEROPTIONS_H_
#define CONSISTENCYTESTEROPTIONS_H_

#include "consist/hypothesistesteroptions.h"

class TesterOptions {
public:
    TesterOptions(int argc, char **argv);
    void checkOptions();

    consist::HypothesisTesterOptions hypothesisOptions;
#ifdef GUI_SUPPORT
    bool gui;
#endif /* GUI_SUPPORT */
    int optimize;
...
#endif /* CONSISTENCYTESTEROPTIONS_H_ */
